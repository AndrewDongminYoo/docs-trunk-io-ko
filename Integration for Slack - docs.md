...
Setup Integration with Slack[](https://docs.trunk.io/merge/integration-for-slack#setup-integration-with-slack)
...
Merge Queue Specific Notifications[](https://docs.trunk.io/merge/integration-for-slack#merge-queue-specific-notifications)
...
User Specific Notifications[](https://docs.trunk.io/merge/integration-for-slack#user-specific-notifications)
...
Configuring Your Integration with Slack[](https://docs.trunk.io/merge/integration-for-slack#configuring-your-integration-with-slack)
...
Merge is paused or resumed



 | 

Receive a notification when merging has been paused or resumed.
...
Receive a notification when a pull request is merged into the target branch.
...
Receive a notification when a pull request is canceled.
...
Receive a notification when a pull request fails tests or otherwise fails to merge into the target branch.
...
Pull request is merged without using Trunk Merge



 | 

Receive a notification when a user merges directly to the target branch without submitting to Trunk Merge. This will cause any in-progress pull requests to be restarted, and typically should only be done in emergencies by designated administrators.
