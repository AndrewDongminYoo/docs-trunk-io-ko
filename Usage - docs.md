...
Basic Usage[](https://docs.trunk.io/check/usage#basic-usage)
...
check[](https://docs.trunk.io/check/usage#check)
...
fmt[](https://docs.trunk.io/check/usage#fmt)
...
Options[](https://docs.trunk.io/check/usage#options)
...
Run check on a [sampling](https://docs.trunk.io/check/usage#sample) of all files in the repo
...
Run in [Continuous Integration mode](https://docs.trunk.io/check/check-cloud-ci-integration/continuous-integration)
...
Recipes[](https://docs.trunk.io/check/usage#recipes)
...
the behavior of a specific linter
...
the formatting of the whole repo
...
the formatting of a specific file



 | 

trunk fmt some/file.py
...
the formatting of all python code with black
...
Options[](https://docs.trunk.io/check/usage#options-1)

#### 

\--filter[](https://docs.trunk.io/check/usage#filter)
...
\--sample[](https://docs.trunk.io/check/usage#sample)
...
Manage the linters[](https://docs.trunk.io/check/usage#manage-the-linters)
...
Discover new tools and available upgrades[](https://docs.trunk.io/check/usage#discover-new-tools-and-available-upgrades)
...
Pinned System Versions[](https://docs.trunk.io/check/usage#pinned-system-versions)

When you enable a packaged or downloaded linter in your `trunk.yaml` and don't specify a version, trunk will attempt to use the version of that tool installed on your system. Trunk will not automatically suggest upgrades for this tool. If you wish to upgrade to the latest version, you will first have to specify a base version in your `trunk.yaml`. See [Configuration](https://docs.trunk.io/check/configuration) for more information about `trunk.yaml`.

### 

Advanced Features[](https://docs.trunk.io/check/usage#advanced-features)
