...
In single-player mode, Trunk creates a [configuration file](./Trunk%20YAML.md) and hides it from Git, so that you can test out Trunk on your own and get familiar with how it works, without committing this file.
