...
We generally strive to maintain backward compatibility between the [Trunk Launcher](./Components.md#trunk-launcher) and the Trunk binary, but you may need to occasionally upgrade the launcher to support the newest version of Trunk.
