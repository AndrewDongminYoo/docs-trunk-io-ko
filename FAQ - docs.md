...
What linters should I be using?[](https://docs.trunk.io/check/faq#what-linters-should-i-be-using)
...
trunk check enable cool\_new\_linter

## 

Why aren't issues showing up anymore?[](https://docs.trunk.io/check/faq#why-arent-issues-showing-up-anymore)
...
There are too many issues showing up[](https://docs.trunk.io/check/faq#there-are-too-many-issues-showing-up)
...
My linters are failing or not running as expected[](https://docs.trunk.io/check/faq#my-linters-are-failing-or-not-running-as-expected)
...
What is the difference between a Linter and a Formatter?[](https://docs.trunk.io/check/faq#what-is-the-difference-between-a-linter-and-a-formatter)
...
What is Hold-the-line (HTL)?[](https://docs.trunk.io/check/faq#what-is-hold-the-line-htl)
...
What does it mean when Trunk Check wants to format an image in my repo?[](https://docs.trunk.io/check/faq#what-does-it-mean-when-trunk-check-wants-to-format-an-image-in-my-repo)
...
Why does Trunk take up so much disk space[](https://docs.trunk.io/check/faq#why-does-trunk-take-up-so-much-disk-space)
...
How to transition to running more linters with Trunk[](https://docs.trunk.io/check/faq#how-to-transition-to-running-more-linters-with-trunk)
...
Upgrading Trunk[](https://docs.trunk.io/check/faq#upgrading-trunk)
...
Runtime & Download Versioning[](https://docs.trunk.io/check/faq#runtime-and-download-versioning)
...
How do I Make a Linter Work with a Different Filetype?[](https://docs.trunk.io/check/faq#how-do-i-make-a-linter-work-with-a-different-filetype)
