...
If you use GitHub, we recommend you follow the [GitHub Integration](./GitHub%20Integration.md) guide.
...
Before running `trunk check --upload` you must have [connected your Github repository to your Trunk account](./Upload%20Trunk%20Check%20Results.md).
