...
Queue Overview[](https://docs.trunk.io/merge/using-the-webapp#queue-overview)
...
![](https://682515401-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2FnJbnA6lfsOCasLYFGPP9%2Fimage.png?alt=media&token=cfc71c35-5817-4410-ae72-068da9848060)

The "view more history" link navigates you to the details page.

### 

Pull Request Details[](https://docs.trunk.io/merge/using-the-webapp#pull-request-details)
...
-   1.
    ...
    Impacted targets to be uploaded for the PRs current SHA (`Parallel` mode only)
...
![](https://682515401-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2FW9ZvWPt32csGPctP6BTg%2Fimage.png?alt=media&token=42077524-20e9-4eb2-8f67-62caec4a6b2f)

PR readiness details for a PR that has been submitted but has not yet entered the merge queue. In this example, the queue is waiting for impacted targets to be uploaded for the PR and is also waiting for the PR to be mergeable according to GitHub.
...
-   3.
    ...
    Download any impacted targets that have been [uploaded](https://docs.trunk.io/merge/impacted-targets#generating-impacted-targets) for the PR (uploading impacted targets is only required for [Parallel](https://docs.trunk.io/merge/configuration#parallel-mode) mode, but this option will still show regardless of mode if impacted targets have been uploaded for the PR)
...
Failures[](https://docs.trunk.io/merge/using-the-webapp#failures)
...
Queue Visualization[](https://docs.trunk.io/merge/using-the-webapp#queue-visualization)
