...
Tools are configured in the `tools` section of [`trunk.yaml`](./Trunk%20YAML.md). As with other settings, you can override these values in your [User YAML](./User%20YAML.md).
