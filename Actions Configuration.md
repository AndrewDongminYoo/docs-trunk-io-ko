...
Actions are defined and enabled in the `actions` section of [`trunk.yaml`](./Trunk%20YAML.md).
...
You can specify one of our built-in runtimes (`node`, `python`, ...) or a system runtime that you define. See the [runtimes documentation](./Trunk%20YAML.md#runtimes) for more information.
