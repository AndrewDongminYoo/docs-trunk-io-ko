...
Check는 일반적으로 로컬 도구([CLI](./CLI.md), [VS 코드 확장](https://marketplace.visualstudio.com/items?itemName=trunk.io)) 및 [CI 도구](check-cloud-ci-integration/continuous-integration/) / [GitHub 봇](check-cloud-ci-integration/get-started/github-integration.md) 등으로 사용됩니다.
